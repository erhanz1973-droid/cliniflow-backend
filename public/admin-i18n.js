...
(function() {
  ...
  console.log('I18N FILE VERSION:', 'v28');
  ...
  const translations = {
    tr: {
      ...
      marketplaceProfile: {
        ...
        sectionReputationHint: "Klinik tarafından yönetilir — Google İşletme ve Trustpilot sayfalarınızdan kopyalayın.",
    ...
    en: {
      ...
      marketplaceProfile: {
        ...
        sectionReputationHint: "Self-managed — copy values from your Google Business and Trustpilot pages.",
    ...
    ru: {
      ...
      dashboard: {
        ...
        nav: { dashboard: "Панель", patients: "Пациенты", travel: "Поездки", treatment: "Лечение", schedule: "Расписание", doctors: "Врачи", chat: "Чат", leads: "Лиды", files: "Файлы", referrals: "Рефералы", marketplaceProfile: "Профиль в каталоге", learningCandidates: "Обучение ИИ", health: "Здоровье", settings: "Настройки" },
        charts: {
      ...
      marketplaceProfile: {
        ...
        sectionReputationHint: "Вводится клиникой — скопируйте с Google Business и Trustpilot.",
    ...
    ka: {
      ...
      dashboard: {
        ...
        nav: { dashboard: "პანელი", patients: "პაციენტები", travel: "მოგზაურობა", treatment: "მკურნალება", schedule: "განრიგი", doctors: "ექიმები", chat: "ჩათი", leads: "ლიდები", files: "ფაილები", referrals: "მოწვევები", marketplaceProfile: "კატალოგის პროფილი", learningCandidates: "AI სწავლა", health: "ჯანმრთელობა", settings: "პარამეტრები" },
        charts: {
      ...
      marketplaceProfile: {
        ...
        sectionReputationHint: "კლინიკის მიერ — დააკოპირეთ Google Business და Trustpilot გვერდებიდან.",
