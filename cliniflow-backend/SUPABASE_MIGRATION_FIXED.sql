...
CREATE TABLE IF NOT EXISTS treatment_plans (
    ...
    approved_by_admin_id UUID, -- Removed foreign key for now, will add later if admins table exists
...
CREATE TABLE IF NOT EXISTS treatment_items (
    ...
    linked_icd10_code VARCHAR(10), -- Removed foreign key for now
